...
function draw()
    ...
    -- Header
    -- -----------------------------------------------------------------------------
    sasl.gl.drawText(fontRMbold, 350, 895, "FLIGHT INFORMATION", 25, false, false, TEXT_ALIGN_CENTER, colourWhite)

    -- -----------------------------------------------------------------------------
    -- Selection boxes
    -- -----------------------------------------------------------------------------
    local atcCommOptions = {
        {line1 = "DEPARTURE", line2 = "CLEARANCE REQ", line2Active = true, pageId = 43, inactive = false},
        {line1 = "ATIS REQUEST", pageId = 47, inactive = false},
        {line1 = "OCEANIC", line2 = "CLEARANCE REQ", line2Active = true, pageId = 20, inactive = true},
        {line1 = "PUSHBACK", line2 = "REQUEST", line2Active = true, pageId = 20, inactive = true},
        {line1 = "METAR REQUEST", pageId = 48, inactive = false},
        {line1 = "TAF REQUEST", pageId = 49, inactive = false}
    }
